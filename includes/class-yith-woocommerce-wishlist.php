...
class GL_YITH_WooCommerce_Wishlist {
    ...
    public function __construct() {
        ...
        if(class_exists('YITH_WCWL')) {
            ...
            add_action( 'woocommerce_before_shop_loop_item', array($this, 'gl_add_logged_out_projects_message') );
            ...
            add_action( 'template_redirect', array($this, 'gl_my_projects_manage_redirect' ));
            ...
            // add_action('init', array($this, 'vrig'));
            // add_filter('query_vars', array($this, 'vrigqv'));
