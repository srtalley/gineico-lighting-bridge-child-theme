...
jQuery(function($) {
        ...
        if($('.wishlist_table').length) {
            $(document).on('click', '.gl-add-all-to-quotation', function(e) {
                ...
                if($(products_needing_options).length) {
                    console.log('we click2');
                    if( typeof $.prettyPhoto === 'undefined' ){
                        return;
                    }
                    console.log('we click3');
                    $.prettyPhoto.open();
                    ...
                    $(this).prettyPhoto(
                        {
                            ...
                            allow_resize          : true,
                            changepicturecallback: function(){
                                console.log('we click5');
                                $('#pp_full_res').find('.pp_inline').html('<div style="text-align: center"><h1 style="font-size: 24px; margin-bottom:30px;">Please select additional options</h1><p>Some of the items in your list have options that need to be selected before adding to a quote.</p> <p>Please add these options before trying again.</p>');
                                // highlight each row
     ...
     */
    function ajax_add_to_quote(button) {
