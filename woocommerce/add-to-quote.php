...
<div
    ...
    ?>
<div
		class="yith_ywraq_add_item_browse-list-<?php echo esc_attr( $product_id ); ?> yith_ywraq_add_item_browse_message gl-continue-shopping <?php echo esc_attr( ( ! $exists ) ? 'hide' : 'show' ); ?> hide-when-removed"
		style="display:<?php echo esc_attr( ( ! $exists ) ? 'none' : 'block' ); ?>"><a
            href="<?php echo esc_url( $return_to_shop_link ); ?>">Continue Shopping</a></div>
    <?php 
    // END CUSTOM
    ?>
