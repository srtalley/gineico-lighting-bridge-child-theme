...
<div class="ywraq-view-quote-wrapper ywraq-status-<?php echo esc_attr( $order->get_status() ); ?>">
	...
	$accept_button_text = ( YITH_Request_Quote()->enabled_checkout() && $order->get_status() !== 'ywraq-pending' ) ? esc_html__( 'Checkout', 'yith-woocommerce-request-a-quote' ) : ywraq_get_label( 'accept' );
	...
	if ( in_array( $order->get_status(), array( 'ywraq-pending' ), true ) ) :
		...
		<p class="ywraq-buttons">
			...
			<a class="ywraq-big-button ywraq-accept"
				...
				<?php echo esc_html( $accept_button_text ); ?></a><?php endif ?>
			<?php
	...
	<div class="ywraq-additional-information">
		<div class="ywraq-customer-information">
			...
			if ( $billing['billing_state'] ) {
				...
				$state   = $states[ $billing['billing_state'] ];
			...
			if ( $billing['billing_country'] ) {
				...
				printf( '<p class="ywraq-view-quote__customer-info"><strong>%s</strong> %s</p>', esc_html__( 'Country:', 'yith-woocommerce-request-a-quote' ), esc_html( $countries[ $billing['billing_country'] ] ) );
			}
