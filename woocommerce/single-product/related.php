...
if($title_tag_options != '') {
	...
	<div class="related products"> <!-- WooCommerce 4 changes these to "sections" instead of divs. If the main theme is updated to support this, these can be changed to sections -->
