					...
					<?php if ( $show_last_column ) : ?>
						<td class="product-add-to-cart">
							...
							if($product->is_type('variable')) {
								// echo '<div class="gl-wishlist-select-options-message">to add to quote.</div>';
								?>
								<div class="yith-ywraq-add-to-quote gl-wcwl-quote-select-options-wrapper">
									...
									<!-- <a href="#gl-wcwl-quote-select-option-variation-button-<?php echo $product->get_id();?>" class="gl-wcwl-quote-select-options button" data-product_id="<?php $product->get_id();?>" >Request a Quote</a> -->
								<?php
